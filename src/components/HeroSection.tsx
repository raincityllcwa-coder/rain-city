import imgHeroImage from "@/assets/f54c0cc7231f70cee3cc02ad5edc8c18c5bbbaf6.webp?url";
...
export function HeroSection() {
  ...
  return (
    <section id="home" className="relative w-full">
      ...
      {/* Content */}
      <div className="relative max-w-[1150px] mx-auto px-4 md:px-8 py-8 md:py-[37px] w-full min-h-[600px] md:min-h-[630px] flex items-end md:items-center">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-[100px] items-start lg:items-center justify-between">
          {/* Hero Text - Hidden on mobile, shown on desktop */}
          <div className="hidden lg:flex flex-col gap-[15px] w-full lg:w-[441px]">
            <h1 className="font-['Lora'] font-bold text-[42px] text-white leading-tight">
              Transform Your Space with Premium Kitchen & Bath Remodeling
            </h1>
            <p className="font-['Montserrat'] font-normal text-[18px] text-white">
              Expert craftsmanship and personalized service for your dream renovation
            </p>
            ...
            <div className="flex gap-3 items-center justify-start mt-1">
              ...
              />
              <p className="font-['Montserrat'] font-bold text-[18px] text-white">
                Bellevue's Top Kitchen & Bath Contractor
              </p>
            </div>
          </div>

          {/* Hero Form - Full width on mobile */}
