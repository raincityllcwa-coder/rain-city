    ...
    <section className="w-full py-12 md:py-16 lg:py-20 bg-white">
      <div className="max-w-[1150px] mx-auto px-4 md:px-8">
        ...
        <div className="mb-10 md:mb-12">
          <h2 className="font-['Lora'] font-bold text-[28px] md:text-[32px] text-black">
            Our Process
          </h2>
        </div>
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="flex items-center gap-4 w-full">
                ...
                <h3 className="font-['Lora'] font-bold text-[20px] md:text-[22px] text-[#3b350e] flex-1">
                  {step.title}
                </h3>
              </div>
              
              {/* Description */}
              <p className="font-['Montserrat'] text-[15px] md:text-[16px] text-black leading-relaxed">
                {step.description}
              </p>
            </div>
          ))}
